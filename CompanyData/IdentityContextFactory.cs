...
namespace CompanyData
{
    ...
    //    //    //"Server=localhost\\SQLEXPRESS;Database=Identity;Trusted_Connection=True;MultipleActiveResultSets=true"

    //    //    var builder = new DbContextOptionsBuilder<AppIdentityDbContext>();
    //    //    builder.UseSqlServer(@"Server = localhost\\SQLEXPRESS; Database = Identity; Trusted_Connection = True;");
