...
namespace CompanyData.Migrations
{
    ...
    [Migration("20180219075936_FocusNodes")]
    partial class FocusNodes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyData.Models.FocusNodes", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("CompanyData.Models.TreeNodes", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("CompanyData.Models.FocusNodes", b =>
                {
                    b.HasOne("CompanyData.Models.FocusNodes", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("CompanyData.Models.TreeNodes", b =>
                {
                    b.HasOne("CompanyData.Models.TreeNodes", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
